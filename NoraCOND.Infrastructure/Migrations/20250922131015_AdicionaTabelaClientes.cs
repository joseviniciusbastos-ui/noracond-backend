        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataCriacao = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UsuarioDeCriacaoId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clientes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Clientes_Usuarios_UsuarioDeCriacaoId",
                        column: x => x.UsuarioDeCriacaoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clientes_UsuarioDeCriacaoId",
                table: "Clientes",
                column: "UsuarioDeCriacaoId");
